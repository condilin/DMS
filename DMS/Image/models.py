...
class Image(models.Model):
    ...
    resolution = models.CharField(max_length=16, verbose_name=u'分辨率', null=True, blank=True)
    ...
    is_learn = models.CharField(max_length=16, verbose_name=u'是否学习', null=True, blank=True)
    diagnosis_label_doctor = models.CharField(max_length=64, verbose_name=u'医生诊断标签', null=True, blank=True)
    diagnosis_label_zhu = models.CharField(max_length=64, verbose_name=u'朱博士诊断标签', null=True, blank=True)
